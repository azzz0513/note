...
## 了解哪些其他的Agent设计范式？Agent和Workflow的区别是什么？
...
## 介绍一下AI Agent的记忆机制，并说明在实际开发中应该如何设计记忆模块？
...
### Context Window管理：短期记忆的工作台不够大怎么办
...
## 说说Single-Agent和Multi-Agent的设计方案？
...
## 在工程实践中，为什么有时候选择手搓Agent而不是直接使用成熟框架？
...
两种路由策略的对比可以用一张图来理解：
![[Pasted image 20260809225005.png]]
...
最核心的区别是通信方向：SSE 是服务端单向推，客户端只能接收，想发消息只能另起一个 HTTP 请求；WebSocket 是全双工，双方都可以随时主动发消息。
...
![[Pasted image 20260813225200.png]]
...
![[Pasted image 20260813225229.png]]
...
![[Pasted image 20260813225503.png]]
...
![[Pasted image 20260813225534.png]]
### SSE的局限：不只是单向那么简单
...
![[Pasted image 20260813225715.png]]
...
![[Pasted image 20260813225902.png]]
...
![[Pasted image 20260813225926.png]]
